const click = () => {
    document.addEventListener('click', function(event) {
        ...
        var count = 1;
        if (event.target.className == "questions__image" && event.target.src !== 'https://iegori.github.io/Syte/assets/images/whiteArrow.svg'){
            event.target.src = "assets/images/whiteArrow.svg"
            count += 1;
            for (var i = 0; i < 5; i++) {
                if (questions__open[i].children[0].src == 'https://iegori.github.io/Syte/assets/images/whiteArrow.svg'){
        ...
        if (event.target.className == "questions__image" && event.target.src == "https://iegori.github.io/Syte/assets/images/whiteArrow.svg" && count !== 2){
            event.target.src = "assets/images/open.svg"
            for (var i = 0; i < 5; i++) {
                if (questions__open[i].children[0].src == 'https://iegori.github.io/Syte/assets/images/open.svg'){
